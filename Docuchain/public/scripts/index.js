...
angular
  ...
  //   // User is considered idle if AFK for 5 seconds
  //   $idleProvider.setIdleTime(5);

  //   // User will timeout at the end of 600 seconds (10 minutes) after considered idle.
  //   $idleProvider.setTimeoutTime(600);

  //   // The $idle service will ping the specified URL to keep the session alive.
  //   $idleProvider.keepalive(true);
  // })
  // Test Purpose
  .config(function ($idleProvider, $keepaliveProvider) {
    ...
    // Change to 2 seconds for testing
    $idleProvider.setIdleTime(5);

    // Change to 3 seconds for testing
    $idleProvider.setTimeoutTime(600);
